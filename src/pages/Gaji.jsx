  ...
  return (
    <MobileLayout title="Gaji">
      ...
      <button
        ...
        className="w-full app-card app-card-hover p-3 flex items-center justify-between text-sm font-semibold mb-4"
      >
        <span>{showDetail ? "Tutup Detail Gaji" : "Lihat Detail Gaji"}</span>
